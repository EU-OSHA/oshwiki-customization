<?php
/**
 * File holding the SFLegacyInput class
 * 
...
/**
 * The SFLegacyInput class.
 *
 * @ingroup SFFormInput
 */
class SFLegacyInput extends SFFormInput{

	/**
	 * Constructor for the SFCompatibilityInput class.
	 *
	...
	public function __construct( $input_number, $cur_value, $input_name, $other_args ) {
		parent::__construct( $input_number, $cur_value, $input_name, $other_args );
	}
